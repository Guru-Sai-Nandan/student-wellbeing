...
import PomodoroImg from '../assets/img/pomodoro.jpg';
...
const Pomodoro = () => {
  ...
  return (
    <div
      ...
      className="overflow-y-hidden bg-cover bg-pomodoro m-1"
      style={{backgroundImage: `url(${PomodoroImg})`}}
    >
      <div className="relative w-full h-full backdrop-brightness-75 bg-slate-900/30">
        {isFullscreen ? (
          <IconWindowMinimize
            onClick={toggleFullScreen}
            className="absolute bottom-5 right-16 m-10 text-white cursor-pointer"
          />
        ) : (
          <IconWindowMaximize
            onClick={toggleFullScreen}
